...
n_wb["Year"] = n_wb["Year"].astype(float)
# %%
new_df = df.merge(n_wb ,how = "outer", left_on= ["ISO3 Alpha-code" ,"Year"] ,  right_on=["Country Code","Year"] , indicator=True)
new_df
# %%
new_df.to_csv(dirname+"/gdp_added.csv")
# %%
